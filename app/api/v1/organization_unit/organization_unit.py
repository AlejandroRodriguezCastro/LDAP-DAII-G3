...
@router.get("/")
async def read_organization_units():
...
@router.delete("/")
async def delete_organization_units():
...
async def delete_organization_unit(org_unit_name: str):
...
@router.post("/")
async def create_organization_unit(org_unit: OrganizationUnit):
